...
return new class extends Migration
{
    ...
    {
        Schema::create('surveilans_nkvs', function (Blueprint $table) {
            $table->id();
            $table->integer('fk_surveilans_nkv_perpanjang')->nullable();
            ...
            $table->mediumText('file_surat_tugas_peninjauan_lapangan')->nullable();
            $table->mediumText('file_berkas_hasil_tinjauan')->nullable();
            $table->mediumText('file_sertifikat_nkv')->nullable();
            $table->integer('level')->nullable();
            $table->date('expired')->nullable();
            $table->integer('masa_berlaku')->nullable()->comment = 'Bulan';
            ...
            $table->integer('status')->default('0')->comment = '0 = Belum Mengajukan ; 1 = Menunggu Periksa ; 2 = Sedang Periksa ; 3 = Belum Sesuai ; 4 = Sesuai ; 5 = Penjadwalan ; 6 = Dalam Peninjauan ; 7 = Selesai';
            $table->integer('status_perpanjang')->default('0')->comment = '0 = Belum ; 1 = Sudah';
    ...
    {
        Schema::dropIfExists('surveilans_nkvs');
    }
};
