                            ...
                            <div class="col-md-12 col-12">
                                <div class="form-group">
                                    ...
                                    <select class="type-select form-control" name="status" id="status">
                                       ...
                                       <option value="5">Penerbitan Rekomendasi</option>
                    ...
                    <form id="form-data-filter" class="form">
                        ...
                        <div class="row">
                            <div class="btn-block-m col-md-12 col-sm-12 col-12 d-flex justify-content-end">
                                ...
                                <a href="{{url('sudin/permohonannkv')}}" type="button" class="btn btn-danger me-1 mb-1">Reset Filter</a>
                            </div>
                        </div>
                    </form>
            </div>
    ...
    <script type="text/javascript">
        ...
        var table = $('#datatable').DataTable({
            ...
            buttons: [
                ...
                {
                    extend: 'csv',
                    title: 'Permohonan Rekomendasi Nomor Kontrol Veteriner (NKV)',
                ...
                },
                {
                    ...
                    customize: function(doc) {
                        doc.content[1].table.widths = ['5%','10%','*','*','10%','10%', '10%', '10%', '10%'];
    ...
    .draw();
        ...
        getData = (id) => {
            $.ajax({
                ...
                url: "{{ url('sudin/permohonannkv/getdata') }}" + '/' + id,
        ...
        $('#form-data').on('submit', e => {
            ...
            var url = "{{ url('sudin/permohonannkv/ubahstatus') }}";
            $.ajaxSetup({
                headers: {
                    'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                }
