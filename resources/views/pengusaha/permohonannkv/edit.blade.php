...
@section('main-content')
    ...
    <div class="card">
        <div class="card-body">
            ...
            @endif
            <form id="postForm" name="postForm" class="form-horizontal" action="{{route('pengusaha.permohonannkv.update')}}"
                  method="POST"
                ...
                <div class="form-group">
                    <div class="row">
                        <label class="col-sm-12"><span class="text-danger">*</span>Tujuan Permohonan</label>
                        <div class="col-sm-12">
                            <input type="text" class="form-control" id="fk_lokasi_sudin" name="fk_lokasi_sudin"
                                placeholder="Pilih Tujuan Permohonan" value="Sudin KPKP {{$get_data->lokasi_sudin_r->lokasi}}" disabled>
                        </div>
                    </div>
                </div>
                <hr>
                ...
                <div class="form-group">
                    <!-- <a type="button" class="btn btn-secondary" href="{{route('pengusaha.permohonannkv')}}"
