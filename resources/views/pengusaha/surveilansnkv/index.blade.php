...
@section('main-content')
                ...
                <div class="card">
                    <div class="card-header">
                        <div class="card-options">
                            <a href="{{url('pengusaha/surveilansnkv/create')}}" class="btn btn-sm btn-pill btn-primary">Tambah
                                Permohonan
                            </a>
    ...
    <script type="text/javascript">
        ...
        var table = $('#datatable').DataTable({
            ...
            processing: true,
            serverSide: true,
            ajax: '{{ url("pengusaha/surveilansnkv") }}',
            aaSorting: [0, 'desc'],
         ...
         ajukanData = (id) => {
            if (confirm("Are You sure want to send this data?")) {
                $.ajax({
                    ...
                    url: "{{ url('pengusaha/surveilansnkv/ajukandata') }}" + '/' + id,
                    beforeSend: function() {
