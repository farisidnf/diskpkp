                                                        ...
                                                        <table class="table">
                                                            ...
                                                            <tbody>
                                                                @php
                                                                    $nokategori = "A";
                                                                @endphp
                                                                @foreach ($ppidnavbar->kategori_r as $datakategori)
                                                                <tr>
                                                                    <td><strong>{{$nokategori}}</strong></td>
                                                                    <td><strong>{{$datakategori->nama}}</strong>
                                                                    </td>
                                                                ...
                                                                @php
                                                                    $noinformasi = 1;
                                                                @endphp
                                                                    @foreach ($datakategori->informasi_r as $datainformasi)
                                                                    <tr>
                                                                        <td>{{$noinformasi}}</td>
                                                                        <td>{{$datainformasi->nama}}</td>

                                                                        <td style="text-align:center" width="140px">
                                                                            <a target="_blank" href="{{asset($datainformasi->file_informasi)}}"
