                            ...
                            <div class="p-5">
                                ...
                                <form method="POST" action="{{ route('authenticate') }}" class="user">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control form-control-user @error('username') is-invalid @enderror" value="" id="username" name="username" placeholder="Username / Email" required>
                                            @error('username')
