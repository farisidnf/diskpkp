                        ...
                        <div class="col-sm-12">
                            <select name="bulan" class="form-control" id="bulan">
                                @foreach (range(1, 12) as $bulan)
                                    ...
                                    @endphp
                                    <option {{ (old('bulan', $post->bulan) == $bulanFormat ||$bulanFormat == date('m')) ? 'selected' : '' }}
                        ...
                        <div class="col-sm-12">
                            <select name="bidang" id="bidang" class="form-control">
                                ...
                                @foreach($fields as $field)
                                    <option {{old('bidang', $post->bidang) == $field->name ? 'selected' : ''}} value="{{ $field->name }}">{{ $field->name }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
