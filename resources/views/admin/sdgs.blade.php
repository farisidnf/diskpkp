...
@section('main-content')
    ...
    <section class="section">
        <div class="section-header">
            <h1>Sustainable Development Goals @if (Auth::user()->role == 'user')
                    ...
                    <div class="card-header">
                        <div class="card-options">
                            @if (Auth::user()->role == 'admin')
                                ...
                                <a href="{{route('admin.sdgs.create')}}" class="btn btn-sm btn-pill btn-primary">Tambah
                                    Data Baru
                                </a>
                            @endif
