...
@section('main-content')
    ...
    <div class="card">
        <div class="card-body">
            <form id="postForm" name="postForm" class="form-horizontal" action="{{route('admin.renstrasasaran.store')}}"
                        ...
                        <div class="col-sm-12">
                            <select name="tahun" class="form-control" id="tahun">
                                ...
                                @foreach($years as $year)
                                    <option value="{{$year->year}}" {{ old('tahun') == $year->year ? 'selected' : '' }}>{{$year->year}}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                        ...
                        <div class="col-sm-12">
                            <select name="indikator_sasaran" class="form-control" id="indikator_sasaran">
                                ...
                                @foreach($targets as $target)
                                    <option value="{{$target->name}}" {{ old('indikator_sasaran') == $target->name ? 'selected' : '' }}>{{$target->name}}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-12">
                            <input type="number" class="form-control" id="target_satuan_berjalan"
                                   ...
                                   value="{{ old('target_satuan_berjalan') }}" required>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-12">
                            <select name="data_triwulan" class="form-control" id="data_triwulan">
                                <option value="Triwulan I" {{ old('data_triwulan') == 'Triwulan I' ? 'selected' : '' }}>
                                    Triwulan I
                                </option>
                                <option value="Triwulan II" {{ old('data_triwulan') == 'Triwulan II' ? 'selected' : '' }}>
                                    Triwulan II
                                </option>
                                <option value="Triwulan III" {{ old('data_triwulan') == 'Triwulan III' ? 'selected' : '' }}>
                                    Triwulan III
                                </option>
                                <option value="Triwulan IV" {{ old('data_triwulan') == 'Triwulan IV' ? 'selected' : '' }}>
                                    Triwulan IV
                                </option>
                                <option value="Tahunan" {{ old('data_triwulan') == 'Tahunan' ? 'selected' : '' }}>
                                    Tahunan
                                </option>
                            </select>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-12">
                            <input type="number" class="form-control" id="target" name="target"
                                   placeholder="Isi jumlah target" value="{{ old('target') }}" required>
                        </div>
                        <div class="form-check ml-3">
                            <input class="form-check-input" type="checkbox" value="N/A" id="targetNa"
                                   name="targetNa" {{ old('targetNa') ? 'checked' : '' }}>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-12">
                        <input type="number" class="form-control" id="realisasi" name="realisasi"
                               placeholder="Isi jumlah realisasi" value="{{ old('realisasi') }}" required>
                    </div>
                    <div class="form-check ml-3">
                        <input class="form-check-input" type="checkbox" value="N/A" id="realisasiNa"
                               name="realisasiNa" {{ old('realisasiNa') ? 'checked' : '' }}>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-12">
                            <select name="status" id="status_" class="form-control">
                                ...
                                <option value="Ada Kesalahan" {{ old('status') == 'Ada Kesalahan' ? 'selected' : '' }}>
                                    Ada Kesalahan
                                </option>
                ...
                <div class="form-group">
                    <a type="button" class="btn btn-secondary" href="{{route('admin.renstrasasaran.index')}}"
