 ...
 <div class="modal-header">
    <h4 class="modal-title">Tambah Indikator Tujuan Baru</h4>
...
<div class="modal-body">
        <form id="form-indikator-tujuan" class="form">
                ...
                <input type="hidden" name="fk_iku_mst" id="fk_iku_mst" value="{{$ikumst_id}}">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 col-12">
                        <div class="form-group">
                            ...
                            <textarea class="type-text form-control" name="judul" id="judul" cols="30" rows="10" placeholder="Masukkan indikator tujuan.."></textarea>
