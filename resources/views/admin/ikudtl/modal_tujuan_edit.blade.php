 ...
 <div class="modal-header">
    <h4 class="modal-title">Edit Indikator Tujuan</h4>
    <button type="button" class="close" data-dismiss="modal">&times;</button>
</div>

<!-- Modal body -->
<div class="modal-body">
        <form id="form-indikator-tujuan" class="form">
                ...
                <div class="row">
                    <div class="col-md-12 col-12">
                        <div class="form-group">
                            <label for="fk_bidang">Bidang<span class="text-danger">*</span></label>
                            <select class="type-select form-control" name="fk_bidang" id="fk_bidang">
                                <option value="">Pilih Bidang</option>
                                @foreach($bidangs as $bidang)
                                <option value="{{$bidang->id}}" {{$data->fk_bidang==$bidang->id ? 'selected' : ''}}>{{$bidang->nama}}</option>
                                @endforeach
                            </select>
                            <span id="fk_bidang-error" class="error invalid-feedback"></span>
                        </div>
                    </div>
                    <div class="col-md-12 col-12">
                        <div class="form-group">
                            <label for="judul">Indikator Tujuan<span class="text-danger">*</span></label>
                            <textarea class="type-text form-control" name="judul" id="judul" cols="30" rows="10" placeholder="Masukkan indikator tujuan..">{{$data->judul}}</textarea>
                    ...
                    <div class="col-md-12 col-12">
                        <div class="form-group">
                            ...
                            <select class="type-select form-control" name="fk_satuan" id="fk_satuan">
                                ...
                                <option value="{{$satuan->id}}" {{$data->fk_satuan==$satuan->id ? 'selected' : ''}}>{{$satuan->nama}}</option>
                                @endforeach
                            </select>
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="text-right decimal type-text form-control" id="kondisi_awal" name="kondisi_awal" placeholder="Masukkan Kondisi Awal..." value="{{editRupiah($data->kondisi_awal)}}">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="text-right decimal type-text form-control" id="target_tahunan" name="target_tahunan" placeholder="Masukkan Target Tahunan..." value="{{editRupiah($data->target_tahunan)}}">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="text-right decimal type-text form-control" id="target_triwulan_1" name="target_triwulan_1" placeholder="Masukkan Target Triwulan 1..." value="{{editRupiah($data->target_triwulan_1)}}">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="text-right decimal type-text form-control" id="target_triwulan_2" name="target_triwulan_2" placeholder="Masukkan Target Triwulan 2..." value="{{editRupiah($data->target_triwulan_2)}}">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="text-right decimal type-text form-control" id="target_triwulan_3" name="target_triwulan_3" placeholder="Masukkan Target Triwulan 3..." value="{{editRupiah($data->target_triwulan_3)}}">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="text-right decimal type-text form-control" id="target_triwulan_4" name="target_triwulan_4" placeholder="Masukkan Target Triwulan 4..." value="{{editRupiah($data->target_triwulan_4)}}">
                    ...
                    <div class="col-md-12 col-12">
                        <div class="form-group">
                            ...
                            <textarea class="type-text form-control" name="keterangan" id="keterangan" cols="30" rows="10" placeholder="Masukkan Keterangan..">{{$data->keterangan}}</textarea>
...
<script>
    $(document).ready(function() {
        ...
        $('#form-indikator-tujuan').on('submit', e => {
            e.preventDefault();
            var formData = new FormData($('#form-indikator-tujuan')[0]);
            // Ubah Link Store Data
            var url = "{{ url('storetujuan') }}";
            $.ajaxSetup({
                headers: {
