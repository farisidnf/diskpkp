 ...
 <div class="modal-header">
    <h4 class="modal-title">Update Indikator Tujuan</h4>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 col-12">
                        <div class="form-group">
                            <label for="judul">Indikator Tujuan</label>
                            <textarea readonly class="type-text form-control" cols="30" rows="10" placeholder="Masukkan indikator tujuan..">{{$data->judul}}</textarea>
