 ...
 <div class="modal-header">
    <h4 class="modal-title">Edit Indikator Sasaran</h4>
                ...
                <div class="row">
                    <div class="col-md-12 col-12">
                        <div class="form-group">
                            ...
                            <textarea class="type-text form-control" name="judul" id="judul" cols="30" rows="10" placeholder="Masukkan indikator sasaran..">{{$data->judul}}</textarea>
