...
@section('main-content')
    ...
    <section class="section">
        <div class="section-header">
            <h1>Rencana Pembangunan Jangka Menengah Daerah @if (Auth::user()->role == 'user')
                    ...
                    <div class="card-header">
                        <div class="card-options">
                            @if (Auth::user()->role == 'admin')
                                ...
                                <a href="{{route('admin.rpjmd.create')}}" class="btn btn-sm btn-pill btn-primary">Tambah
                                    Data Baru
                                </a>
                            @endif
                            <span style="margin-left:20px;"> Filter : </span>
                            <select name="bulan" id="filterbulan" class="form-control"
                                ...
                                @foreach (range(1, 12) as $bulan)
                                    ...
                                    @endphp
                                    <option value="{{ $bulanFormat }}">{{ $namaBulan }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
        ...
        $('body').on('click', '.deletePost', function () {
            ...
            if (confirm("Are You sure want to delete this User!")) {
                ...
                $.ajax({
                    ...
                    url: "{{ route('admin.rpjmd.store') }}" + '/' + id,
                    success: function (data) {
                        table.draw();
                    },
                    error: function (data) {
