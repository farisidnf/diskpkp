...
@section('main-content')
    ...
    <section class="section">
        <div class="section-header">
            <h1>Satu Data Indonesia @if (Auth::user()->role == 'user')
                    ...
                    <div class="card-header">
                        <div class="card-options">
                            ...
                            @if (Auth::user()->role == 'admin')
                                <a href="{{route('admin.sdi.create')}}" class="btn btn-sm btn-pill btn-primary">Tambah Data Baru</a>
                                <a href="{{route('admin.field.create')}}" class="btn btn-sm btn-pill btn-primary">Tambah Bidang Baru</a>
                            @endif
                            ...
                            <select name="filterbulan" id="filterbulan">
                                ...
                                @foreach (range(1, 12) as $bulan)
                                    ...
                                    @endphp
                                    <option {{ $bulanFormat == date('m') ? 'selected' : '' }} value="{{ $bulanFormat }}">
                                        {{ $namaBulan }}</option>
                                @endforeach
                            </select>
