...
@section('main-content')
    ...
    <section class="section">
        <div class="section-header">
            <h1>Program @if (Auth::user()->role == 'user')
                    ...
                    <div class="card-header">
                        <div class="card-options">
                            @if (Auth::user()->role == 'admin')
                                <a href="{{route('admin.program.create')}}" class="btn btn-sm btn-pill btn-primary mr-1">Tambah Data Baru</a>
                                <a href="{{route('admin.year.create')}}" class="btn btn-sm btn-pill btn-primary mr-1">Tambah Tahun Baru</a>
                                <a href="{{route('admin.master-program.create')}}" class="btn btn-sm btn-pill btn-primary mr-1">Tambah Program Baru</a>
                                <a href="{{route('admin.master-indikator-program.create')}}" class="btn btn-sm btn-pill btn-primary mr-1">Tambah Indikator Baru</a>
                            @endif
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form id="postForm" name="postForm" class="form-horizontal">
                        ...
                        <div class="form-group">
                            <label for="criteria" class="col-sm-12">Indikator <span style="color:brown;"></span></label>
                            <div class="col-sm-12">
                                <input type="text" class="form-control" id="indikator" name="indikator"
                                       placeholder="Nama Indikator" value="" required>
                            </div>
                        </div>

                        <div class="form-group">
                            <label for="criteria" class="col-sm-12">Satuan Data</label>
                            <div class="col-sm-12">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-12">
                                <input type="number" class="form-control" id="target_tahun_berjalan"
                                       name="target_tahun_berjalan" placeholder="Target Pertahun" value=""
                                       required>
                            </div>
                        </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-12">
                                <textarea name="keterangan" class="form-control" id="keterangan" cols="30" rows="10"
                                          placeholder="Isi Keterangan (minimal 50 karakter)"></textarea>
                    </div>
                </div>
    ...
    <script type="text/javascript">
        ...
        $('#createNewPost').click(function () {
            ...
            $('#modelHeading').html("FORM PROGRAM");
        ...
        $('body').on('click', '.editPost', function () {
            ...
            $.get("{{ route('admin.program.index') }}" + '/' + id + '/edit', function (data) {
                $('#modelHeading').html("FORM EDIT PROGRAM");
                ...
                $('#target_tahun_berjalan').val(data.target_tahun_berjalan);
            })
        });
        ...
        $('body').on('click', '.deletePost', function () {
            ...
            if (confirm("Are You sure want to delete this User!")) {
                ...
                $.ajax({
                    ...
                    url: "{{ route('admin.program.store') }}" + '/' + id,
                    success: function (data) {
                        table.draw();
                    },
                    error: function (data) {
